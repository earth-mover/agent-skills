...
If any grib index files are present (often identifiable by the file suffix `.index`), pass `use_index=True` to the `GribberishParser` to significantly speed up the parsing.
