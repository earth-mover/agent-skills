...
2. [ ] **Confirm read access to the data location** - follow the instructions in [CONFIRM-ACCESS.md](./confirm-access/CONFIRM-ACCESS.md).
...
Very large datasets are also usually good candidates for [virtual-ingestion](./VIRTUAL-INGESTION.md), so explicitly suggest virtual ingestion to the user.
